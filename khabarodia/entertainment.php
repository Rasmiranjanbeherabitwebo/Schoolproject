                                ...
                                <div class="main-menu float- collapse navbar-collapse" id="main-menu-2">
                                    <nav>                                        
                                        <ul class="menu one-page">                                        
                                             ...
                                             <li class='active'><a href='entertainment.php'>ମନୋରଞ୍ଜନ</a></li>
            ...
            <div id="service-area">
                <div class="ptb-120">
                    <div class="container">
                        ...
                        <div class="row">
                            <?php
                            $sql="select * from newslist where category='ମନୋରଞ୍ଜନ' order by id desc limit 5";
                        ...
                        <div class="row" style="margin-top: 50px">
                            <div class="col-lg-8 col-md-8 col-sm-12 p-0">
                                <?php 
                                    ...
                                    $sql="select * from newslist where category='ମନୋରଞ୍ଜନ' order by date desc,id asc";// where sub_category='breaking_news' id desc limit 4";
                                    $result = mysqli_query($conn, $sql);
                                    $row_cnt = $result->num_rows;
                                   // echo $row_cnt;
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <?php 
                                    ...
                                    $sql="select * from advertisementList where category='ମନୋରଞ୍ଜନ' limit 4";// where sub_category='breaking_news' id desc limit 4";
                                    $result = mysqli_query($conn, $sql);
                                    $row_cnt = $result->num_rows;
                                   // echo $row_cnt;
                                    for ($i=0; $i < $row_cnt; $i++) { 
