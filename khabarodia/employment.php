                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-xs-12">
                                <div class="logo float-left navbar-header">
                                    ...
                                    <a class="navbar-brand" href="index.php"><img src="img/khabarodia_logo.jpeg" style="width: 150px"></a>                         
                                </div>
                                <div class="main-menu float- collapse navbar-collapse" id="main-menu-2">
                                    <nav>                                        
                                        <ul class="menu one-page">                                        
                                             ...
                                             <li class='active'><a href='employment.php'>ନିଯୁକ୍ତି </a></li>
            ...
            <div id="service-area">
                <div class="ptb-120">
                    <div class="container">
                        ...
                        <!-- <div class="row">
                            <?php
                            $sql="select * from newslist where category='ନିଯୁକ୍ତି' order by id desc limit 5";
                                ...
                                for($i=1; $i<=$row_cnt; $i++)
                                {
                                  ...
                                  if($i==4){
                                        echo '
                                                <div class="col-6 col-lg-6 col-md-6 col-sm-12 pointerDiv" style="height: 240px;/* margin-bottom:5px; */padding: 0px 0px 5px 5px;" onclick="openNewsDetails('.$row["id"].')">
                        ...
                        <div class="row" style="margin-top: 50px">
                            <div class="col-lg-8 col-md-8 col-sm-12 p-0">
                                <?php 
                                    ...
                                    $sql="select * from newslist where category='ନିଯୁକ୍ତି' order by date desc,id asc";// where sub_category='breaking_news' id desc limit 4";
                                    $result = mysqli_query($conn, $sql);
                                    $row_cnt = $result->num_rows;
                                   // echo $row_cnt;
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <?php 
                                    ...
                                    $sql="select * from advertisementList where category='ନିଯୁକ୍ତି' limit 4";// where sub_category='breaking_news' id desc limit 4";
                                    $result = mysqli_query($conn, $sql);
                                    $row_cnt = $result->num_rows;
                                   // echo $row_cnt;
                                    for ($i=0; $i < $row_cnt; $i++) { 
                        ...
                        <div class="text-center" style="height: 500px"><h2 style="margin-top: 200px">Coming Soon ...</h2></div>                    
                    </div>
                </div>
            </div>
